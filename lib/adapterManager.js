...
function validateDataSourceProperties(adapter,datasourceProperties){
  var model = mongoose.model('Datasource Adapter properties',adapter.datasourceProperties);
...
function validateQueryProperties(adapter,queryProperties){
  var model = mongoose.model('Query Adapter properties',adapter.queryProperties);
